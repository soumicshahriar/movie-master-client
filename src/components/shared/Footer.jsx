...
const Footer = () => {
  ...
  return (
    <footer className="footer bg-base-400 shadow-2xl shadow-white py-8 px-4 text-base-content mt-10 w-full">
      <div className="container mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 w-full">
          ...
          <div className="flex-1 ">
            <h4 className="font-medium text-sm mb-3 text-center md:text-start">
            ...
            <ul className="flex md:flex-col gap-2">
              <li>
                <a
                  href="/"
                  className="link link-hover text-sm hover:text-primary"
                >
                  Home
                </a>
              </li>
